...
<article class="group overflow-hidden rounded-md border border-zinc-200 bg-white shadow-sm shadow-zinc-200/70 transition duration-300 hover:-translate-y-1 hover:border-emerald-200 hover:shadow-xl hover:shadow-zinc-200">
    ...
    <div class="space-y-4 p-4">
        ...
        <div class="flex items-center justify-between gap-3 border-t border-zinc-100 pt-4">
            ...
            <a href="{{ route('products.show', $product) }}" class="rounded-md border border-zinc-200 px-3 py-2 text-xs font-extrabold text-zinc-700 transition hover:border-emerald-200 hover:bg-emerald-50 hover:text-emerald-800">
                Detail
            </a>
        </div>
    </div>
