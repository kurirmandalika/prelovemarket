    ...
    <section class="border-b border-zinc-200 bg-white">
        <div class="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
            <div class="grid gap-6 lg:grid-cols-[1fr_auto] lg:items-end">
                <div>
                    <p class="text-sm font-extrabold uppercase text-emerald-700">Katalog marketplace</p>
                    <h1 class="mt-2 text-3xl font-extrabold text-zinc-950 sm:text-4xl">Produk Preloved</h1>
                ...
                <div class="grid grid-cols-2 gap-3 sm:grid-cols-3 lg:min-w-[24rem]">
                    <div class="rounded-md bg-zinc-950 p-4 text-white">
                        <p class="text-2xl font-extrabold">{{ $products->total() }}</p>
                        <p class="mt-1 text-xs font-semibold text-zinc-300">Produk tersedia</p>
                    </div>
                    <div class="rounded-md bg-emerald-50 p-4">
                        <p class="text-2xl font-extrabold text-emerald-800">{{ $categories->count() }}</p>
                        <p class="mt-1 text-xs font-semibold text-emerald-700">Kategori</p>
                    </div>
                    <div class="rounded-md bg-amber-50 p-4">
                        <p class="text-2xl font-extrabold text-amber-800">{{ count($conditions) }}</p>
